...
RUN mkdir engineering-electro-magnetics-laboratory-iitd

COPY src/ /engineering-electro-magnetics-laboratory-iitd/src

WORKDIR ./engineering-electro-magnetics-laboratory-iitd/src
