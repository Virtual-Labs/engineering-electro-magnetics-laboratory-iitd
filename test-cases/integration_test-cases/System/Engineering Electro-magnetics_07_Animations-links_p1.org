...
* Objective
  - To view the Animations of the Measurement of VSWR on a line experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the Animations link 
  2. It should re-direct to the Animations page
  3. Click on the Links present in the Animations page

* Expected result
  1. Animations page should be opened
